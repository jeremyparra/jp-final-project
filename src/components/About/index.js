        ...
        <div id="aboutBox">
            ...
            <div className="row">
                <div className="col-md-6">
                    <img src="https://dummyimage.com/150x150/13294b/4B9CD3.png&text=Owner+Photo" id="ownerPhoto" />
                    <p id="ownerBio">
                ...
                <div className="col-md-6">
                    ...
                    <iframe id="youTube" width="380" height="300" src="https://www.youtube.com/embed/c4oTCw33U-4" 
